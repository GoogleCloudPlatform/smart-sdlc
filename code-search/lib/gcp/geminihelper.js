...
async function callPredict(codeBase, userQuery) {
    ...
    /* Getting the prompt */
    let fullRequest = contextFile.getContext();
    fullRequest += codeBase.toString();
    fullRequest += "\n**User Query:**\n";
    fullRequest += userQuery.toString();

    /* Building our request */
    const req = {
        contents: [{role: 'user', parts: [{text: fullRequest}]}],
    };
