...
Aplicação/Serviço em NodeJS + Express para gerar Relatório de Dependências.  
...
O prompt enviado para a plataforma do **Vertex AI** é lido dos arquivos `config/*_XX.txt`.  
