...
App/Service in NodeJS + Express to evaluate User Story documents.  
...
The prompts that are sent to **Vertex AI** are present on the following files `config/content_XX.txt` e `config/format_XX.txt`.  
